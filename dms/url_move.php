...
if ($HTTP_POST_VARS["hdn_url_move"])
	{
	$location = "url_options.php?obj_id=".$HTTP_POST_VARS['hdn_obj_id'];
	...
	dms_auditing($HTTP_POST_VARS['hdn_file_id'],"url/move/dest folder id=".$HTTP_POST_VARS['rad_folder_id']);
	dms_message("The web page has been moved to the selected destination folder.");
	...
	print "  <form method='post' name='frm_select_dest' action='url_move.php'>\r";
	display_dms_header(2);
	
	print "  <tr><td colspan='2'><BR></td></tr>\r";
	print "  <tr><td colspan='2' align='left'><b>Move Web Page</b></td></tr>\r";
	print "  <tr><td colspan='2'><BR></td></tr>\r";
	print "  <tr>\r";
	print "    <td colspan='2' align='left'>Web Page Name:&nbsp;&nbsp;&nbsp;";
	print "        ".$obj_name."</td>\r";
	print "  </tr>\r";
	print "  <tr><td colspan='2'><BR></td></tr>\r";
	...
	print "</table>\r";
	print "<input type='hidden' name='hdn_url_move' value='confim'>\r";
