...
// Get the link object information
$query  = "SELECT template_obj_id,obj_name,obj_status,obj_checked_out_user_id,time_stamp_create,current_version_row_id,lifecycle_id ";
$query .= "FROM ".$dmsdb->prefix("dms_objects")." ";
$query .= "WHERE obj_id='".$orig_obj_id."'";  
//print $query;
$orig_object = $dmsdb->query($query,'ROW');
...
if($dms_config['document_email_enable']=='1')
	{
	print "<a href='file_email.php?obj_id=".$obj_id."&return_url=file_link_options.php?obj_id=".$link_id."'>". _DMS_EMAIL. "</a>&nbsp;\r";
	}
...
if ($perms_level > BROWSE)
	print "<a href='#' title='View Document' onclick='javascript:void(window.open(\"file_retrieve.php?function=view&obj_id=".$obj_id."\"))'><font size='3'><b>".$orig_object->obj_name."</b></font></a>\r";
else
	print "<font size='3'><b>".$orig_object->obj_name."</b></font>\r";
